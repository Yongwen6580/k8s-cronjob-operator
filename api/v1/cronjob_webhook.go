...
//+kubebuilder:webhook:path=/mutate-batch-tutorial-kubebuilder-io-v1-cronjob,mutating=true,failurePolicy=fail,groups=batch.devops.lession.io,resources=cronjobs,verbs=create;update,versions=v1,name=mcronjob.kb.io,sideEffects=None,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-batch-devops-lession-io-v1-cronjob,mutating=false,failurePolicy=fail,sideEffects=None,groups=batch.devops.lession.io,resources=cronjobs,verbs=create;update,versions=v1,name=vcronjob.kb.io,admissionReviewVersions=v1
...
func (r *CronJob) validateCronJob() error {
	...
	return apierrors.NewInvalid(
		schema.GroupKind{Group: "batch.devops.lession.io", Kind: "CronJob"},
		r.Name, allErrs)
}
